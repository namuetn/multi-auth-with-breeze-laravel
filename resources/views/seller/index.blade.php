...
@section('seller')
    ...
    <header class="header_area">
        ...
        <ul class="header_menu">
            <li>
                <a href="#" class="search_btn" data-toggle="modal" data-target="#myModal"><i class="fas fa-search"></i></a>
            ...
            <li>
                <a data-toggle="dropdown" href="#"><i class="far fa-envelope"></i><span>4</span></a>
                    ...
                    <ul class="dropdown_body nice_scroll scrollbar">
                        <li>
                            <a href="#">
                                ...
                                <div class="text-part">
                                    <h6>
                                        Madelyn <span><i class="far fa-clock"></i> today</span>
                                    </h6>
                                    <p>Hello Sam...</p>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="text-part">
                                    <h6>
                                        Melvin <span><i class="far fa-clock"></i> today</span>
                                    </h6>
                                    <p>Hello jhon...</p>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="text-part">
                                    <h6>
                                        Olinda <span><i class="far fa-clock"></i> today</span>
                                    </h6>
                                    <p>Hello jhon...</p>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="text-part">
                                    <h6>
                                        Johnson <span><i class="far fa-clock"></i> today</span>
                                    </h6>
                                    <p>Hello Olinda...</p>
                                </div>
                            </a>
            ...
            <li>
                <a href="#" data-toggle="dropdown"><i class="far fa-bell"></i><span>9</span></a>
            ...
            <li>
                <a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                <div class="user_item dropdown-menu dropdown-menu-right">
                    ...
                    <ul>
                        <li>
                            <a href="#">
                                <span><i class="fas fa-user"></i></span> User Profile
                            </a>
                        </li>
                        <li>
                            <a href=" ">
                                <span><i class="fas fa-cogs"></i></span> Password Change
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('seller.logout') }}">
                                <span><i class="fas fa-unlock-alt"></i></span> Logout
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="content_wrapper">
        ...
        <h3>Login Seller Email: {{ auth()->guard('seller')->user()->email }}</h3>
